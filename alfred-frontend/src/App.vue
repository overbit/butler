<template>
    <div id="app" class="">
        <!--<div id="nav">
         ...
         <nav class="navbar navbar-expand-lg navbar-light align-items-baseline" style="">
                <a class="navbar-brand pws_logo--bg" href="http://www.abcam.com"></a> 
                <ul class="navbar-nav mr-auto">
                </ul>
                
                <h1 class="nav-item d-md-none">Alfred</h1>
                <h1 class="nav-item d-none d-md-block">Alfred here Sir, at your service</h1>
        </nav>
        <router-view />
    </div>
</template>
...
<style scoped>
    ...
    @font-face {
        ...
        src: url(/assets/LubalinGraphStd-Medium.woff2) format("woff2"),
             url(/assets/LubalinGraphStd-Medium.woff) format("woff");
        font-style: normal;
        font-weight: 400
    }
</style>